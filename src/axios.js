...
function wxLoginRedirect() {
  window.location.href = `https://apps.hqu.edu.cn/wechat-hqu/wechatauth.html?proxyTo=authoauth&sendUrl=/connect/oauth2/authorize?appid=wxfe035b066fb1158b&redirect_uri=${encodeURIComponent(`${location.origin}`)}&encode_flag=Y&response_type=code&scope=snsapi_userinfo#wechat_redirect`
}

// 1. inject api baseurl
axios.defaults.baseURL = 'https://graduate.sends.cc/api/'
const axiosInstance = axios.create({
  baseURL: 'https://graduate.sends.cc/api/'
})
